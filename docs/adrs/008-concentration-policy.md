...
5. **Drawdown stop portfolio (0.20) conservé et tire EN PREMIER, par design.** Cluster -30% ≈ -20% portfolio = stop ~-€8,5K, *avant* le seuil de douleur déclaré (-€11K). On ne relève PAS le stop pour consommer la tolérance : le frein qui agit dans la descente est une feature, pas un bug.
