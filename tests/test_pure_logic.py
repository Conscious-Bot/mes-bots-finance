...
def test_format_decision_summary_returns_nonempty_string():
    d = {
        ...
        "decision_type": "entry",
        "direction": "long",
        "price_at_decision": 130.0,
        "reasoning": "Strong AI demand",
    }
...
def test_format_thesis_card_minimal_thesis():
    ...
    thesis = {"ticker": "AAPL", "direction": "long", "conviction": 3, "status": "active", "entry_price": 200}
    card = format_thesis_card(thesis)
    assert "AAPL" in card
...
def test_format_thesis_card_with_drivers_and_invalidation():
    thesis = {
        ...
        "status": "active",
        "entry_price": 130,
        "key_drivers": ["AI capex", "Datacenter growth"],
...
def test_build_revisit_questions_returns_string_with_3_questions():
    thesis = {
        ...
        "invalidation_triggers": ["DC slowdown"],
    }
