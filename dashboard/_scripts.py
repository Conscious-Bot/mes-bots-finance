...
_NAV = (
    ...
    '<div class="nitem" data-nav="strategie"><svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M5.5 7.5 L 7 4 L 8.5 7.5 L 10.5 3.5 L 12 7.5 L 13.5 3.5 L 15.5 7.5 L 17 4 L 18.5 7.5 L 16.5 15 L 7.5 15 Z"/><rect x="6.5" y="15" width="11" height="2"/><path d="M5 18 L 19 18 L 20.5 22 L 3.5 22 Z"/></svg><span class="nlab">Strategy</span></div>'
