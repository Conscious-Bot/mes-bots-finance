...
_NAV = (
    # Nav order 26/06 (user dictee) : Overview / Positions / Concentration / Theses
    # / Cards / Strategy / Cerebro / Copilot / Alerts.
    # Logique : signaux (Overview/Positions/Concentration/Theses) -> deep-dive (Cards)
    # -> contraintes du portefeuille (Strategy) -> second cerveau (Cerebro)
    # -> adversaire (Copilot) -> alarmes (Alerts).
    '<nav class="nav" role="navigation" aria-label="Main navigation">'
    '<div class="nitem on" data-nav="vigie" aria-current="page" title="Overview — Discipline posture &amp; what to act on today"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14a8 8 0 0 1 16 0"/><path d="M12 14l4.5-3.5"/><circle cx="12" cy="14" r="1.3" fill="currentColor" stroke="none"/></svg><span class="nlab">Overview</span></div>'
    '<div class="nitem" data-nav="positions" title="Positions — Holdings + asymmetry + gauge per ticker"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4l8 4-8 4-8-4 8-4z"/><path d="M4 12l8 4 8-4"/><path d="M4 16l8 4 8-4"/></svg><span class="nlab">Positions</span></div>'
