...
_NAV = (
    # Pass 14 audit 6 #5 : title= attributes pour discovery natif des labels
    # (hover .nlab existe deja mais user ne sait pas qu'il faut hover).
    ...
    # Pass 6 audit IA : Concentration AVANT Theses (decomposition risque arrive
    # juste apres Positions, Theses = justification ensuite).
