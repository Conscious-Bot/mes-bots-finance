...
_NAV = (
    ...
    '<div class="nitem" data-nav="strategie"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M8 7 L 9 4 L 10.5 6 L 12 3 L 13.5 6 L 15 4 L 16 7"/><circle cx="9" cy="4" r="0.6" fill="currentColor" stroke="none"/><circle cx="12" cy="3" r="0.6" fill="currentColor" stroke="none"/><circle cx="15" cy="4" r="0.6" fill="currentColor" stroke="none"/><path d="M8 7h8"/><path d="M8 7 C 7 10, 7 13, 8 17 L 16 17 C 17 13, 17 10, 16 7"/><path d="M6 17 L 18 17 L 20 22 L 4 22 Z"/></svg><span class="nlab">Strategy</span></div>'
