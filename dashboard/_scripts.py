...
_NAV = (
    ...
    '<div class="nitem" data-nav="strategie"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v4"/><path d="M10 4h4"/><path d="M9 7h6"/><path d="M9 7 C 7 9, 7 13, 9 17 L 15 17 C 17 13, 17 9, 15 7"/><path d="M7 17 L 17 17 L 19 22 L 5 22 Z"/></svg><span class="nlab">Strategy</span></div>'
