...
def _concentration(
    ...
    verdict_card = (
        ...
        + f'<span class="pt" style="font-size:13px;color:var(--ink);margin-top:4px;line-height:1.5">{over_nm or "aucune"}</span></div>'
        + "</div></div>"
    )
    return (
...
def _geo_bars(positions: list[dict]) -> str:
    ...
    css = (
        ...
        ".geo-stk{display:flex;align-items:center;gap:var(--s3);padding:5px 6px 5px 16px;"
...
def _cockpit() -> str:
    ...
    css = (
        ...
        ".ck-sub{font-size:12px;color:var(--steel);margin-top:5px;line-height:1.4}"
        "</style>"
    )
...
_CSS = """
  ...
  * { box-sizing:border-box; }
  ...
  .nlab { position:absolute; left:56px; top:50%; transform:translateY(-50%); white-space:nowrap; background:var(--panel); border:1px solid var(--line2); border-radius:var(--r2); padding:7px 12px; font-family:var(--fb); font-size:13px; font-weight:500; color:var(--ink); opacity:0; pointer-events:none; transition:opacity .14s ease; z-index:80; box-shadow:0 10px 26px -12px #000; }
  ...
  .hero .hl { font-family:var(--fb); font-size:10px; letter-spacing:.2em; text-transform:uppercase; color:var(--steel); margin-bottom:8px; }
  .hero .hsub { font-size:13px; color:var(--steel); margin-top:6px; }
  ...
  .sec-cols { display:grid; grid-template-columns:1fr 92px 96px 58px 72px 78px; gap:var(--s3); padding:2px 16px 9px; font-family:var(--fb); font-size:10px; letter-spacing:.16em; text-transform:uppercase; color:var(--steel); border-bottom:1px solid var(--line); margin-bottom:12px; }
  ...
  .sec-row { display:grid; grid-template-columns:1fr 92px 96px 58px 72px 78px; gap:var(--s3); align-items:center; padding:7px 16px; border-radius:var(--r2); font-family:var(--fm); font-size:13px; cursor:pointer; transition:background .12s; }
  ...
  .th-anchor { grid-column:1/-1; margin-top:8px; padding:8px 11px; border-radius:var(--r2); font-family:var(--fb); font-size:12px; line-height:1.5; color:var(--ink); border-left:2px solid var(--id); }
  ...
  .ghead { display:flex; justify-content:space-between; align-items:baseline; margin-bottom:11px; } .ghead .gl { font-family:var(--fb); font-weight:600; font-size:10px; letter-spacing:.18em; text-transform:uppercase; color:var(--steel); } .ghead .gv { font-family:var(--fm); font-weight:500; font-size:20px; letter-spacing:-.01em; font-variant-numeric:tabular-nums; }
  ...
  .dt th { text-align:left; font-family:var(--fb); font-size:10px; letter-spacing:.12em; text-transform:uppercase; color:var(--steel); padding:8px 10px; border-bottom:1px solid var(--line2); cursor:pointer; user-select:none; }
  ...
  .dtier { font-family:var(--fb); font-size:10px; letter-spacing:.12em; text-transform:uppercase; color:var(--steel); margin:16px 0 6px; padding-bottom:6px; border-bottom:1px solid var(--line); }
  ...
  .drow { display:grid; grid-template-columns:14px 1fr auto auto auto; align-items:center; gap:var(--s3); padding:7px 0; font-size:13px; }
  ...
  .lp-score { display:flex; align-items:center; gap:var(--s3); margin:8px 0; font-size:12px; }
  ...
  .hrow.star .pfcard .distcap { font-size:13px; margin-top:12px; }
  .hrow.star .pfcard .sub2 { font-size:13px; padding-top:18px; }
  ...
  .gradecard .gsub-ev { font-family:var(--fm); font-size:11px; color:var(--steel); line-height:1.55; padding-top:6px; border-top:1px solid color-mix(in srgb,var(--ink) 6%,transparent); }
  ...
  .riskwatchcard .rw-lens { font-family:var(--fm); margin:10px 0 4px; padding:9px 12px; background:color-mix(in srgb, var(--warn) 5%, transparent); border-left:2px solid var(--warn); border-radius:2px; font-size:12px; color:var(--ink); line-height:1.55; }
  ...
  .riskwatchcard .rw-h { font-family:var(--fb); font-size:10px; letter-spacing:.16em; text-transform:uppercase; color:var(--steel); margin-bottom:5px; }
  ...
  .riskwatchcard .rw-t { font-family:var(--fm); font-size:11px; color:var(--steel); margin-top:4px; }
  ...
  .riskwatchcard .rw-mit-h { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:5px; }
  ...
  .calibcard .calib-msg { margin-top:10px; font-family:var(--fm); font-size:13px; color:var(--ink2); line-height:1.55; padding-top:10px; border-top:1px solid var(--line); }
  ...
  .strategiecard .us-cta-f { font-size:11px; color:var(--steel); margin-top:8px; font-family:var(--fm-mono, monospace); }
  ...
  .blindcard .ba-head { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:4px; }
  ...
  .copilotcard .cp-brief-label { font-family:var(--fb); font-size:10px; letter-spacing:.16em; text-transform:uppercase; color:var(--steel); margin-bottom:6px; }
  .copilotcard .cp-brief { font-family:var(--fm); font-size:13px; color:var(--ink); line-height:1.6; padding:10px 12px; background:color-mix(in srgb,var(--ink) 4%,transparent); border-radius:var(--r2); border-left:2px solid color-mix(in srgb,var(--ink) 15%,transparent); }
  .copilotcard .cp-head { display:flex; align-items:center; gap:var(--s3); flex-wrap:wrap; margin-bottom:6px; }
  ...
  .narrativecard .nv-h { font-family:var(--fb); font-size:11px; letter-spacing:.18em; text-transform:uppercase; color:var(--steel); margin-bottom:8px; }
  .narrativecard .nv-line { display:flex; align-items:baseline; gap:8px; padding:6px 0; border-bottom:1px solid color-mix(in srgb,var(--ink) 4%,transparent); font-size:12px; }
  ...
  .conversationscard .cv-meta { display:flex; align-items:center; gap:8px; margin-bottom:5px; font-family:var(--fb); font-size:10px; letter-spacing:.14em; text-transform:uppercase; }
  ...
  .chatsigcard .cs-kind { font-family:var(--fb); font-size:10px; letter-spacing:.18em; text-transform:uppercase; color:var(--steel); margin-bottom:10px; }
  ...
  .conceptionscard .bc-head { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:7px; flex-wrap:wrap; }
  ...
  .preferencescard .pr-row { display:flex; align-items:baseline; gap:var(--s3); padding:5px 0; border-bottom:1px solid color-mix(in srgb,var(--ink) 3%,transparent); font-size:12px; }
  ...
  .axescard .ax-h { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:10px; padding-bottom:8px; border-bottom:1px solid color-mix(in srgb,var(--ink) 5%,transparent); }
  ...
  .factorscard .fe-head { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:5px; }
  ...
  .trajcard .tr-row { display:flex; align-items:baseline; gap:var(--s3); padding:7px 0; border-bottom:1px solid color-mix(in srgb,var(--ink) 3%,transparent); font-size:12px; }
  ...
  .spofcard .sp-head { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:5px; }
  ...
  .mauboussincard .ms-row { display:grid; grid-template-columns:70px 50px 65px 75px 75px 75px 65px auto; align-items:center; gap:var(--s3); padding:7px 0; border-bottom:1px solid color-mix(in srgb,var(--ink) 3%,transparent); font-size:12px; }
  ...
  .valocard .vb-head { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:6px; }
  ...
  .killcard .kc-row.at_risk { border-left:3px solid var(--warn); padding-left:12px; margin-left:-12px; }
  .killcard .kc-head { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:5px; }
  ...
  .vgcard .vg-head { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:4px; }
  ...
  .wactcard .wact-recent { display:flex; gap:12px; align-items:baseline; padding:5px 0; font-family:var(--fm); font-size:12px; border-bottom:1px solid color-mix(in srgb,var(--ink) 4%,transparent); }
  ...
  .wrappercard .wr-mis { display:flex; align-items:baseline; gap:var(--s3); padding:6px 0; border-bottom:1px solid color-mix(in srgb,var(--ink) 3%,transparent); font-size:12px; }
  ...
  .fxcard .fx-head { display:flex; align-items:baseline; gap:var(--s3); margin-bottom:5px; }
  ...
  .benchcard .bm-warn { font-family:var(--fm); font-size:12px; color:var(--warn); background:color-mix(in srgb,var(--warn) 8%,transparent); padding:8px 12px; border-radius:var(--r2); margin:12px 0 0; }
  ...
  .clustercard .dc-row { display:flex; align-items:baseline; gap:var(--s3); padding:6px 0; border-bottom:1px solid color-mix(in srgb,var(--ink) 4%,transparent); font-size:12px; }
  ...
  .chatcard .chat-log { max-height:340px; overflow-y:auto; padding:12px 0; margin-bottom:var(--s35); display:flex; flex-direction:column; gap:var(--s3); }
  ...
  .chatcard .chat-foot { font-family:var(--fm); font-size:11px; color:var(--steel); margin-top:10px; }
  .chatcard .chat-idle-clear { align-self:center; background:color-mix(in srgb,var(--steel) 8%,transparent); color:var(--steel); font-style:italic; font-size:12px; padding:8px 14px; }
