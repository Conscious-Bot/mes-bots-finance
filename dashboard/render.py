...
_NAV = (
    ...
    '<div class="nitem" data-nav="theses"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="4"/><circle cx="12" cy="12" r="1" fill="currentColor" stroke="none"/></svg><span class="nlab">Theses</span></div>'
    '<div class="nitem" data-nav="strategie"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9 L7 14 L10 10 L12 14 L14 10 L17 14 L19 9 V18 H5 Z"/><path d="M5 14h14"/></svg><span class="nlab">Strategy</span></div>'
    '<div class="nitem" data-nav="methode"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="13" r="1.6" fill="currentColor" stroke="none"/><path d="M8.6 9.6a5 5 0 0 0 0 6.8"/><path d="M15.4 9.6a5 5 0 0 1 0 6.8"/><path d="M6 7a8.5 8.5 0 0 0 0 12"/><path d="M18 7a8.5 8.5 0 0 1 0 12"/></svg><span class="nlab">Method</span></div>'
...
_CSS = """
  * { box-sizing:border-box; }
  ...
  .page-star .ps-lbl { font-family:var(--fm); font-size:14px; letter-spacing:.16em; text-transform:uppercase; color:var(--steel); margin-bottom:8px; }
  /* Tag exploratoire : marque visuelle que le modele sous-jacent n'a pas valide OOS strict. Honnete > invente (L3). */
  .ps-tag-explor { display:inline-block; margin-left:7px; padding:2px 7px; font-size:12px; font-weight:600; letter-spacing:.1em; text-transform:uppercase; color:var(--warn); background:color-mix(in srgb,var(--warn) 12%,transparent); border:1px solid color-mix(in srgb,var(--warn) 35%,transparent); border-radius:var(--r1); font-family:var(--fm); cursor:help; }
  .page-star .ps-val { font-family:var(--fb); font-size:27px; font-weight:500; color:var(--ink); line-height:1.1; }
  ...
  .page-star .ps-val[style*="font-size:37px"], .page-star .ps-val[style*="font-size: 37px"] {
  ...
  .page-star .ps-cap { font-family:var(--fb); font-size:16px; color:var(--steel); margin-top:8px; line-height:1.4; }
  .page-star .ps-macro-row { display:flex; align-items:baseline; gap:14px; flex-wrap:wrap; }
  .page-star .ps-macro-meta { font-family:var(--fm); font-size:16px; color:var(--steel); }
  ...
  .page-star .ps-frise-labs { display:flex; justify-content:space-between; font-family:var(--fm); font-size:14px; color:var(--steel); margin-top:10px; letter-spacing:.06em; }
  ...
  .page-star .ps-foot { font-family:var(--fm); font-size:15px; color:var(--steel); }
  ...
  .page-star .ps-grade-letter { font-family:var(--fb); font-size:45px; font-weight:500; line-height:1; flex-shrink:0; background-clip:text; -webkit-background-clip:text; -webkit-text-fill-color:transparent; color:transparent; }
  ...
  .page-star .ps-grade-num { font-family:var(--fb); font-size:25px; font-weight:500; color:var(--ink); margin-bottom:8px; }
  .page-star .ps-grade-max { font-family:var(--fm); font-size:16px; color:var(--steel); font-weight:400; }
  ...
  .spk-tip { position:absolute; bottom:calc(100% + 8px); transform:translateX(-50%); background:var(--ink); color:var(--bg); padding:5px 10px; border-radius:var(--r1); font-family:var(--fm); font-size:14px; font-weight:500; white-space:nowrap; pointer-events:none; z-index:60; box-shadow:0 4px 12px rgba(0,0,0,.2); }
  ...
  .cta-bar button { font-family:var(--fb); font-size:16px; font-weight:500; color:var(--ink); background:transparent; border:none; padding:10px 18px; border-radius:24px; cursor:pointer; display:flex; align-items:center; gap:8px; transition:background .15s,color .15s; }
  ...
  .cta-bar kbd { font-family:var(--fm); font-size:13px; padding:1px 5px; background:color-mix(in srgb,var(--ink) 10%,transparent); border-radius:4px; opacity:.7; border:none; }
  ...
  .cta-tag { margin-left:auto; font-family:var(--fm); font-size:13px; padding:2px 7px; border-radius:10px; background:color-mix(in srgb,var(--warn) 18%,transparent); color:var(--warn); text-transform:uppercase; letter-spacing:.06em; font-weight:600; }
  ...
  .empty-ico { display:inline-block; width:24px; height:24px; border-radius:50%; background:color-mix(in srgb,var(--steel) 18%,transparent); margin-bottom:10px; line-height:24px; color:var(--steel); font-family:var(--fm); font-size:16px; font-weight:600; }
  ...
  .bdg { display:inline-block; margin-left:var(--s2); font-family:var(--fb); font-size:14px; letter-spacing:.1em; text-transform:uppercase; color:var(--id); border:1px solid color-mix(in srgb, var(--acc2) 40%, transparent); border-radius:3px; padding:1px 5px; vertical-align:middle; }
  ...
  .lp-hint code { font-family:var(--fm); font-weight:600; color:var(--ink); background:color-mix(in srgb,var(--ink) 5%,transparent); padding:1px 5px; border-radius:3px; font-size:14px; }
  ...
  .calibcard .calib-status { font-family:var(--fm); font-weight:500; font-size:16px; letter-spacing:.08em; text-transform:uppercase; padding:3px 10px; border-radius:2px; background:color-mix(in srgb, var(--ink) 6%, transparent); }
  ...
  .strategiecard .us-cta-f code { background:color-mix(in srgb, var(--ink) 6%, transparent); padding:2px 6px; border-radius:2px; font-size:14px; }
