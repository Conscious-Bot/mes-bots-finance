...
_CSS = """
  ...
  * { box-sizing:border-box; }
  ...
  .phead { margin-bottom:22px; } .phead h2 { font-family:"Orbitron",var(--fd); font-weight:600; font-size:30px; margin:0 0 8px; letter-spacing:.12em; text-transform:uppercase; color:var(--ink); } .phead .sub { font-family:var(--fb); font-weight:400; font-size:12px; letter-spacing:.04em; color:var(--steel); }
...
def render() -> Path:
    ...
    html = (
        ...
        '<link href="https://fonts.googleapis.com/css2?family=Geist:wght@100;200;300;400;500;600;700&family=Geist+Mono:wght@400;500;600&family=Orbitron:wght@400;500;600;700;800&display=swap" rel="stylesheet">'
        "<style>"
        + _CSS
        + "</style></head><body>"
        + body
