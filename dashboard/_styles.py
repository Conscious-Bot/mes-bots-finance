...
_CSS = """
  * { box-sizing:border-box; }
  ...
  .dband { display:flex; align-items:center; gap:10px; padding:6px 14px; margin:0 0 var(--s35); border:1px solid var(--line3); border-radius:var(--r-pill); background:var(--panel); cursor:pointer; transition:border-color .15s,background .15s; font-size:13px; width:fit-content; }
