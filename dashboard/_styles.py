...
_CSS = """
  * { box-sizing:border-box; }
  ...
  /* Pass 16 audit screenshot user (re-fix) : PROGRESS colonne droite restait
     coupee. Cure plus radicale :
     - .brk-tbl wrapper overflow-x:auto + width:100% pour contraindre le flex.
     - table.dt width:max-content pour qu'il fasse sa largeur naturelle.
     - Le wrapper scrolle si plus large que viewport. */
  ...
  /* Fade visuel right edge pour signaler "scrollable" sans hard cut */
  .brk-tbl { -webkit-mask-image: linear-gradient(to right, black 0, black calc(100% - 24px), transparent 100%); mask-image: linear-gradient(to right, black 0, black calc(100% - 24px), transparent 100%); }
  .brk-tbl:hover, .brk-tbl:focus-within { -webkit-mask-image: none; mask-image: none; }
