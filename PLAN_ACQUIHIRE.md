...
- **Jalon A3 (post-10/06) — Sourcing primaire** : ajouter ≥2 feeds primaires (SEC EDGAR RSS + earnings calendar) pour permettre des signaux "strong" qui débloquent la diversité de la cohorte directionnelle. Sans ça, calibration plot stuck à 1 bucket [0.60-0.62]. **Diagnostic 30/05** : 100% des 312 signaux des 60 derniers jours viennent de newsletters (Short Squeez, Wall Street Rollup, Torsten Slok...). 77% narrative/opinion. Zero feed primaire. C'est la brique fondamentale manquante pour Path 6.
